...
const ChooseUs = () => {
  ...
  return (
    <section className="flex flex-col  justify-between md:flex-row p-[10px] lg:gap-[80px] gap-[20px] py-[4rem] ">
      ...
      <motion.div
        ...
        className="flex flex-col md:gap-[38px] gap-[25px] w-full"
      >
        ...
        <ul className="flex flex-col gap-[15px]">
          {chooseusdata.map((choose) => (
            <li key={choose.id} className="flex items-center gap-[7px]">
              ...
              />
              <h1 className=" font-[500] text-[16px] leading-[20px] text-[#2E2E2E]">
                {choose.text}
              </h1>
            </li>
          ))}
        ...
        <div className="flex gap-[5px]">
          <h1 className=" font-[500] text-[16px] leading-[20px] text-normalBlue-0">
            Learn More
          </h1>
