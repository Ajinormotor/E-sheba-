...
const Header = () => {
  ...
  return (
    <section
      ref={headerRef}
      className={`sticky top-0 z-[1200] w-full max-w-[1300px]  p-[15px] md:p-0   flex flex-col   bg-lightBlue-0 
items-center justify-between  md:px-8 transition-all ${
    ...
    >
      <div
        className={`${
          toggleMenu
            ? "block fixed z-[1200] w-full top-[79px] left-0"
            : "hidden"
        }`}
      >
      ...
      <div className="flex items-center z-[1200] w-full py-[0.2rem] md:p-[20px] justify-between px-[0.5rem]">
        ...
        hover:after:w-full hover:text-normalBlue-0  py-1 ${
          isActive
        ...
        <div className="hidden lg:flex gap-[15px]">
          <button className="bg-transparent hover:bg-normalBlue-0 group w-[122px] h-[51px] border-[1px] border-[#0360D9] rounded-[50px] flex items-center justify-center">
            <h1 className=" font-[600] text-[20px] leading-[26px] text-normalBlue-0 group-hover:text-white font-ibm">
              Log in
            </h1>
          </button>
