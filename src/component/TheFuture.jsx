  ...
  return (
    <section className="flex flex-col items-center justify-between md:flex-row p-[10px] lg:gap-[20px] gap-[20px] py-[2rem]">
      <motion.div
        ...
        whileInView="visible"
        exit="next"
        className="flex flex-col md:gap-[28px] gap-[25px] max-w-[502px] w-full"
      >
        <h1 className=" font-[700] md:text-[48px] md:leading-[62px] text-[38px] leading-[50px] text-[#2E2E2E] font-ibm">
          The Future <br /> of{" "}
          <span className="text-normalBlue-0"> Quality Health </span>{" "}
        </h1>

        <ul className="flex flex-col gap-[15px]">
          <li className="flex">
            <p className=" font-[400] text-[16px] leading-[20px] text-[#2E2E2E] font-ibm">
